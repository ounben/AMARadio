...
### Installation
The latest version (v0.99.4) introduces significant performance optimizations and advanced caching. You can download the application from the releases page or your preferred app store.
